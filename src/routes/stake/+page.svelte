  ...
  const questions = [
    {
      ...
      answer:
        "The SHITZU community runs a validator with a 50% staking fee. This staking pool emits various meme tokens from the NEAR ecosystem, which help subsidize the staking fee.",
    },
    {
...
<div class="w-full">
  ...
  <h2>FAQ</h2>
  <div>
    {#each questions as faq (faq.question)}
      <details
      ...
      >
        <summary class="w-full px-1 list-none marker:hidden">
          ...
          >
            ...
            <div
              id="chevron"
              class="ml-6 flex h-7 items-center rotate-0 transform transition-all duration-300 i-mdi:chevron-down w-7"
            />
          </div>
        </summary>
